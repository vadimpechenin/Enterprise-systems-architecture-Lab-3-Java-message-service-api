...
import com.example.wokers_machines_l2.entity.EntityInterface;
...
public abstract class XmlAndMailController {
    private static final String EMAIL = "java_lessons_v@mail.ru";
    @Autowired
